                            ...
                            <form method="POST" action="{{ route('user.data.submit') }}" class="mt-3">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control checkUser" id="username" name="username" placeholder="@lang('Set Username')" required type="text" value="{{ old('username') }}">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">@lang('Mobile')</label>
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label class="form-control-label">@lang('Address')</label>
                                        <input type="text" class="form-control" name="address" placeholder="@lang('Enter address')" value="{{ old('address') }}">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label class="form-control-label">@lang('State')</label>
                                        <input type="text" class="form-control" name="state" placeholder="@lang('Enter State')" value="{{ old('state') }}">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label class="form-control-label">@lang('Zip Code')</label>
                                        <input type="text" class="form-control" name="zip" placeholder="@lang('Enter Zip')" value="{{ old('zip') }}">
                                    </div>

                                    <div class="form-group col-sm-6">
                                        <label class="form-control-label">@lang('City')</label>
                                        <input type="text" class="form-control form-control" name="city" placeholder="@lang('Enter City')" value="{{ old('city') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="orng_btn1 btn btn--base-two w-100">@lang('Submit')</button>
                                </div>
                            </form>
                        </div>
                    </div>
